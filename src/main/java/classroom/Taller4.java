...
public class Taller4 {
    ...
    public static void main(String[] args) {
        Persona[] estudiantes1 = new Persona[3]; // array de Person llamado estudiantes1
        estudiantes1[0] = new Persona(188220);
        estudiantes1[1] = new Persona(); // error eliminado
        ...
        asignatura2.setCodigoInterno(882);
        ...
        System.out.println(new Asignatura().n);
